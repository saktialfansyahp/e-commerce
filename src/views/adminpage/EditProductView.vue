...
export default {
  ...
  methods: {
    ...
    fetchData() {
      axios
        .get("/api/admin/product/" + this.product_id)
        .then((response) => {
    ...
    editProduct() {
      ...
      axios
        .put("/api/admin/product/" + this.product_id, this.product)
        .then((response) => {
